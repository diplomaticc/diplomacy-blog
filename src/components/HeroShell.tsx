      ...
      <section className="relative min-h-[100svh] overflow-hidden bg-page-cream">
        ...
        >
          <img
            ...
            className="hero-sky-image absolute top-0 left-0 w-full h-[28svh] object-cover object-bottom"
          />
        ...
        <div className="absolute inset-0 z-10">
          ...
          <div className="absolute inset-x-0 bottom-0 z-20 flex flex-col items-center justify-center px-6 pb-10 pt-[9.5rem] text-center sm:px-8 sm:pb-14 sm:pt-[12rem] md:pt-[14rem] lg:pb-16 lg:pt-[18rem]">
            <motion.h2
              ...
              className="max-w-[15ch] font-display text-[1.65rem] leading-[0.92] font-bold uppercase tracking-[0.03em] text-navy-text sm:max-w-none sm:text-[2.5rem] md:text-[3.35rem] lg:text-[5.5rem]"
            >
              <span className="block">BORDERS ARE DRAWN</span>
              <span className="mt-3 block bg-[linear-gradient(to_right,#dc2626,#111827)] bg-clip-text text-transparent">
                IN BLOOD AND INK
              </span>
            </motion.h2>
